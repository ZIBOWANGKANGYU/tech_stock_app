...
# Now that the app has been created, I want to use the shinytest2 package to test the app.
# How should I create the folder structure and write the test script for the app?
